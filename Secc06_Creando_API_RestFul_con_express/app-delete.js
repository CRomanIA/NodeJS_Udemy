...
//Secc6Cap64: Manejo Solicitudes HTTP Delete
...
app.delete('/api/users/:id', (req,res) => {
    ...
    //identificar el indice del usuario encontrado, para luego eliminar el usuario a partir del indice con el metodo 
    const index = users.indexOf(user);
    //ewliminar elemento del indice
